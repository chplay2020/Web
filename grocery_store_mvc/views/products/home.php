   ...
   <section class="home-category">
      ...
      <div class="box-container">
         ...
         <div class="box">
            ...
            <a href="/category?category=fruits" class="btn">fruits</a>
         </div>
         ...
         <div class="box">
            ...
            <h3>meat</h3>
            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Exercitationem, quaerat.</p>
            <a href="/category?category=meat" class="btn">meat</a>
         </div>
         ...
         <div class="box">
            ...
            <h3>vegitables</h3>
            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Exercitationem, quaerat.</p>
            <a href="/category?category=vegitables" class="btn">vegitables</a>
         </div>
         ...
         <div class="box">
            ...
            <h3>fish</h3>
            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Exercitationem, quaerat.</p>
            <a href="/category?category=fish" class="btn">fish</a>
         </div>
